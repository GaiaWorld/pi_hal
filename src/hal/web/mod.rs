...
extern "C" {
    ...
    pub fn horizontalAdvanceOfGlyphIndex(face: JsValue, glyph_index: u32) -> f32;
    ...
    pub fn toOutlineOfGlyphIndex(face: JsValue, glyph_index: u32) ->JsValue;
    // pub fn toOutline3(face: JsValue, text: String) ->JsValue;
    pub fn glyphIndex(face: JsValue, text: String) -> u32;
    pub fn glyphIndexs(face: JsValue, text: String, script: u32) -> Vec<u32>;
